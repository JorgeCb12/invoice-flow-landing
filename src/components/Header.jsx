import img from "../assets/resources/logotipo.svg";
...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 border-b border-white/5 bg-dark-900/60 backdrop-blur-md">
      <div className="container mx-auto px-6 md:px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity">
          <img src={img} alt="Logotipo InvoiceFlow" className="h-6 w-auto" />
        </div>
